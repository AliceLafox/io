...
public class ImageSortControllerTest {
    ...
    public void testImagesSortIndexToLast() throws Exception {
        ...
        mockMvc.perform(get("/image/list/" + token.getReadToken()))
                ...
                .andExpect(jsonPath("$.images[0].id").value(img0.getId().toString()))
                .andExpect(jsonPath("$.images[1].id").value(img1.getId().toString()))
                .andExpect(jsonPath("$.images[2].id").value(img2.getId().toString()))
                .andExpect(jsonPath("$.images[3].id").value(img3.getId().toString()))
                .andExpect(jsonPath("$.images[4].id").value(img4.getId().toString()))
                .andExpect(jsonPath("$.images[5].id").value(img5.getId().toString()))
        ...
        mockMvc.perform(get("/image/list/" + token.getReadToken()))
                ...
                .andExpect(jsonPath("$.images").isNotEmpty())
                .andExpect(jsonPath("$.images[0].id").value(img0.getId().toString()))
                .andExpect(jsonPath("$.images[1].id").value(img2.getId().toString()))
                .andExpect(jsonPath("$.images[2].id").value(img3.getId().toString()))
                .andExpect(jsonPath("$.images[3].id").value(img4.getId().toString()))
                .andExpect(jsonPath("$.images[4].id").value(img5.getId().toString()))
                .andExpect(jsonPath("$.images[5].id").value(img1.getId().toString()))
                .andExpect(jsonPath("$.images[0].sortIndex").value(1))
    ...
    public void testImagesSortIndexToFirst() throws Exception {
        ...
        mockMvc.perform(get("/image/list/" + token.getReadToken()))
                ...
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
                .andExpect(jsonPath("$.images").isNotEmpty())
                .andExpect(jsonPath("$.images[0].id").value(img2.getId().toString()))
                .andExpect(jsonPath("$.images[1].id").value(img0.getId().toString()))
                .andExpect(jsonPath("$.images[2].id").value(img1.getId().toString()))
                .andExpect(jsonPath("$.images[3].id").value(img3.getId().toString()))
                .andExpect(jsonPath("$.images[4].id").value(img4.getId().toString()))
                .andExpect(jsonPath("$.images[5].id").value(img5.getId().toString()))
    ...
    public void testImagesSortIndexPlus() throws Exception {
        ...
        mockMvc.perform(get("/image/list/" + token.getReadToken()))
                ...
                .andExpect(jsonPath("$.images[1].id").value(img1.getId().toString()))
                .andExpect(jsonPath("$.images[2].id").value(img3.getId().toString()))
                .andExpect(jsonPath("$.images[3].id").value(img2.getId().toString()))
                .andExpect(jsonPath("$.images[4].id").value(img4.getId().toString()))
                .andExpect(jsonPath("$.images[5].id").value(img5.getId().toString()))
                .andExpect(jsonPath("$.images[0].sortIndex").value(1))
                .andExpect(jsonPath("$.images[1].sortIndex").value(2))
        ...
        mockMvc.perform(get("/image/list/" + token.getReadToken()))
                ...
                .andExpect(jsonPath("$.images[2].id").value(img3.getId().toString()))
                .andExpect(jsonPath("$.images[3].id").value(img4.getId().toString()))
                .andExpect(jsonPath("$.images[4].id").value(img2.getId().toString()))
                .andExpect(jsonPath("$.images[5].id").value(img5.getId().toString()))
                .andExpect(jsonPath("$.images[0].sortIndex").value(1))
                .andExpect(jsonPath("$.images[1].sortIndex").value(2))
                .andExpect(jsonPath("$.images[2].sortIndex").value(3))
        ...
        mockMvc.perform(get("/image/list/" + token.getReadToken()))
                ...
                .andExpect(jsonPath("$.images[3].id").value(img4.getId().toString()))
                .andExpect(jsonPath("$.images[4].id").value(img5.getId().toString()))
                .andExpect(jsonPath("$.images[5].id").value(img2.getId().toString()))
                .andExpect(jsonPath("$.images[0].sortIndex").value(1))
                .andExpect(jsonPath("$.images[1].sortIndex").value(2))
                .andExpect(jsonPath("$.images[2].sortIndex").value(3))
                .andExpect(jsonPath("$.images[3].sortIndex").value(4))
    ...
    public void testImagesSortIndexMinus() throws Exception {
        ...
        mockMvc.perform(get("/image/list/" + token.getReadToken()))
                ...
                .andExpect(jsonPath("$.images").isNotEmpty())
                .andExpect(jsonPath("$.images[0].id").value(img0.getId().toString()))
                .andExpect(jsonPath("$.images[1].id").value(img3.getId().toString()))
                .andExpect(jsonPath("$.images[2].id").value(img1.getId().toString()))
                .andExpect(jsonPath("$.images[3].id").value(img2.getId().toString()))
                .andExpect(jsonPath("$.images[4].id").value(img4.getId().toString()))
                .andExpect(jsonPath("$.images[5].id").value(img5.getId().toString()))
        ...
        mockMvc.perform(get("/image/list/" + token.getReadToken()))
                ...
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
                .andExpect(jsonPath("$.images").isNotEmpty())
                .andExpect(jsonPath("$.images[0].id").value(img3.getId().toString()))
                .andExpect(jsonPath("$.images[1].id").value(img0.getId().toString()))
                .andExpect(jsonPath("$.images[2].id").value(img1.getId().toString()))
                .andExpect(jsonPath("$.images[3].id").value(img2.getId().toString()))
                .andExpect(jsonPath("$.images[4].id").value(img4.getId().toString()))
