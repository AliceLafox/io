...
CREATE OR REPLACE FUNCTION sort_index_minus(_id TEXT) RETURNS void AS $BODY$
DECLARE
  _token_id    BIGINT;
  _sort_index  BIGINT;
  _sort_index2 BIGINT;
...
CREATE OR REPLACE FUNCTION sort_index_plus(_id TEXT) RETURNS void AS $BODY$
DECLARE
  _token_id    BIGINT;
  _sort_index  BIGINT;
  _sort_index2 BIGINT;
...
CREATE OR REPLACE FUNCTION sort_index_to_first(_id TEXT) RETURNS void AS $BODY$
DECLARE
  _token_id       BIGINT;
...
CREATE OR REPLACE FUNCTION sort_index_to_last(_id TEXT) RETURNS void AS $BODY$
DECLARE
  _token_id       BIGINT;
...
DROP FUNCTION IF EXISTS sort_index_minus(TEXT);
DROP FUNCTION IF EXISTS sort_index_plus(TEXT);
DROP FUNCTION IF EXISTS sort_index_to_first(TEXT);
DROP FUNCTION IF EXISTS sort_index_to_last(TEXT);
